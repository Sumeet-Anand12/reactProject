            ...
            <div className={`sidebar ${context.isOpenFilters===true && 'open'}`}>
                                ...
                                return (
                                    <Link to={`/cat/${item.cat_name.toLowerCase()}`}>
                                        <div className='catItem d-flex align-items-center'>
                                            ...
                                            <h4 className='mb-0 marginLeft mr-3 text-capitalize'>{item.cat_name}</h4>
                                            <span className='d-flex align-items-center justify-content-center rounded-circle MargingLeft'>
                ...
                <div className='card border-0 shadow'>
                    ...
                    <div className='d-flex pt-2 pb-2 priceRange'>
                        ...
                        <span className='marginLeft'>To: <strong className='text-success'>Rs: {value[1]}</strong></span>
                    </div>
